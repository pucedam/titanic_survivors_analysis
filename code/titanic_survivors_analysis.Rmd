...
tener una idea más clara de cómo se distribuyen y, posteriormente, se procederá a __seleccionar los datos de interés__ y a __generar nuevas
...
- **Age** tiene __177 valores nulos__ y su valor debe ser mayor de cero. En este caso, lo ideal sería generar un modelo de regresión que predijese la edad ya que puede depender de la clase, el sexo pero sobre todo de la clase y el precio, ya que los niños pagan menos. Por simplicidad, __imputamos a estos valores nulos la mediana de las edades__.
...
- Por último, realizaremos un __modelo no supervisado__ para ver cómo afectan cada variable a la supervivencia de los pasajeros.
...
Se han aplicando dos métodos (__silhouette__ y __wss__) basados en el codo para elegir un número de agrupaciones y ambos coinciden en 9.
...
Los cuales no proporcionan agrupaciones bien diferenciadas de individuos que sobreviven y que no lo hacen:
